...
<c:if test="${empty articlePage}">
	<%
		RequestDispatcher rd = request.getRequestDispatcher("Writer_Search_Comment.do");
...
<body>
	...
	<div id="container">
		...
		<div id="wrap">
			<div id="category">
				<ul>
					<li><a class="menuLink" href="Writer_Search.do?userNickName=${requestScope.userNickName}">작성글</a></li>
					<li class="comment"><a class="menuLink"
						href="Writer_Search_Comment.do?userNickName=${requestScope.userNickName}">작성댓글</a></li>
				</ul>
			</div>
				...
				<table>
					...
					<c:forEach var="article" items="${articlePage.content}">
						<tr>
							<td>${article.num}</td>
							<td><a
								href="Read_Community.do?no=${article.boardnum}&pageNo=${articlePage.currentPage}"><c:out
										value="${article.content}"></c:out></a></td>
