                  ...
                  <tr>
                     <td colspan="5">
                        ...
                        <c:if test="${articlePage.startPage > 5}">
                           <a href="Category_Community.do?category=QnA&pageNo=${articlePage.startPage - 5}">[이전]</a>
                        </c:if> 
                        ...
                        <c:if test="${articlePage.endPage < articlePage.totalPages}">
                           <a href="Category_Community.do?category=QnA&pageNo=${articlePage.startPage + 5 }">[다음]</a>
                        </c:if>
                     </td>
                  </tr>
               </c:if>
