   ...
   <div id="container">
      ...
      <div id="wrap">
         ...
         <div id="btn">
            ...
            <div id="search">
               <form action="Category_Community.do" method="post">
               <input type="hidden" name="category" value="정보">
                  ...
                  <tr>
                     <td colspan="5">
                        ...
                        <c:if test="${articlePage.startPage > 5}">
                           <a href="Category_Community.do?category=%EC%A0%95%EB%B3%B4&pageNo=${articlePage.startPage - 5}">[이전]</a>
                        </c:if> 
                        ...
                        <c:if test="${articlePage.endPage < articlePage.totalPages}">
                           <a href="Category_Community.do?category=%EC%A0%95%EB%B3%B4&pageNo=${articlePage.startPage + 5 }">[다음]</a>
                        </c:if>
                     </td>
                  </tr>
               </c:if>
