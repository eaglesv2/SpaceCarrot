	...
	<div id = "container">
        <div id = "header">
       	...
       	<div id = "wrap">
       		<div id = "category">
       			<ul>
       				<li><a class="menuLink" href="Community_List_Free.jsp">자유</a></li>
       				<li><a class="menuLink" href="Community_List_Info.jsp">정보</a></li>
       				<li><a class="menuLink" href="Community_List_Q&A.jsp">Q&A</a></li>
       				<li class = "review_tab"><a class="menuLink" href="Community_List_Review.jsp">리뷰</a></li>
       			</ul>
       		</div>
