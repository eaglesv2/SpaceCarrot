		...
		<ul>
			<li>
				...
				<c:if test="${articlePage.startPage > 5}">
					<a href="Search_Category_Commerce.do?category=book&pageNo=${articlePage.startPage - 5}">[이전]</a>
				</c:if> 
				...
				<c:if test="${articlePage.endPage < articlePage.totalPages}">
					<a href="Search_Category_Commerce.do?category=book&pageNo=${articlePage.startPage + 5 }">[다음]</a>
				</c:if>
			</li>
		</ul>
	</c:if>
