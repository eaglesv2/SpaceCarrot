...
public class Community_ListArticleService_SearchCategory {

	private SpaceCarrotDAO_Board_Community boardDao = null;
	private int size = 7; // 한 페이지에 나타낼 게시글 수

	public Community_ArticlePage getArticlePage(int pageNum, String input_Category) throws ClassNotFoundException {
